...
<script>
  ...
  const ICON_SVGS = {
    default: GMSVG("M440-183v-274L200-596v274l240 139Zm80 0 240-139v-274L520-457v274Zm-40-343 237-137-237-137-237 137 237 137ZM160-252q-19-11-29.5-29T120-321v-318q0-22 10.5-40t29.5-29l280-161q19-11 40-11t40 11l280 161q19 11 29.5 29t10.5 40v318q0 22-10.5 40T800-252L520-91q-19 11-40 11t-40-11L160-252Zm320-228Z"),
    ...
    recreation_center: GMSVG("M592-379q49-39 63-101h-83q-12 27-37 43.5T480-420q-30 0-55-16.5T388-480h-83q14 62 63 101t112 39q63 0 112-39ZM405.5-554.5Q420-569 420-590t-14.5-35.5Q391-640 370-640t-35.5 14.5Q320-611 320-590t14.5 35.5Q349-540 370-540t35.5-14.5Zm220 0Q640-569 640-590t-14.5-35.5Q611-640 590-640t-35.5 14.5Q540-611 540-590t14.5 35.5Q569-540 590-540t35.5-14.5ZM480-120l-58-50q-101-88-167-152T150-437q-39-51-54.5-94T80-620q0-94 63-157t157-63q52 0 99 22t81 62q34-40 81-62t99-22q94 0 157 63t63 157q0 46-15.5 89T810-437q-39 51-105 115T538-170l-58 50Zm0-108q96-83 158-141t98-102.5q36-44.5 50-79t14-69.5q0-60-40-100t-100-40q-47 0-87 26.5T518-666h-76q-15-41-55-67.5T300-760q-60 0-100 40t-40 100q0 35 14 69.5t50 79Q260-427 322-369t158 141Zm0-266Z"),
    music_center: GMSVG("M127-167q-47-47-47-113t47-113q47-47 113-47 23 0 42.5 5.5T320-418v-342l480-80v480q0 66-47 113t-113 47q-66 0-113-47t-47-113q0-66 47-113t113-47q23 0 42.5 5.5T720-498v-165l-320 63v320q0 66-47 113t-113 47q-66 0-113-47Z"),
  ...
  const CATEGORY_LABEL_META = {
    "อื่น ๆ": { iconKey: "default", color: "#205a41" },
    ...
    "ศูนย์ฝึกดนตรี กองการสังคีต": { iconKey: "music_center", color: "#0071ce" },
  ...
  function rebuildCategoryMetaIndex() {
    ...
    apiCats.forEach(({ slug, name }) => {
      ...
      const label = name || base.label || slug || "อื่น ๆ";
    ...
    if (!next.default) {
      next.default = { label: "อื่น ๆ", iconKey: "default", color: DEFAULT_CATEGORY_COLOR };
    }
  ...
  function catMeta(key) {
    ...
    return {
      label: taxName || meta.label || key || "อื่น ๆ",
