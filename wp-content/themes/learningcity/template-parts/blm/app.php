...
<div id="blmApp" class="bg-slate-50 text-slate-900 blm-theme" data-mode="<?php echo esc_attr($mode); ?>" data-place-id="<?php echo esc_attr($place_id); ?>">
  <?php get_template_part('template-parts/blm/topbar'); ?>

  <div class="h-full blm-shell">
