<div data-modal-content="modal-category" class="modal items-end p-0!">
    ...
    <div class="card-modal rounded-none! max-w-full">
        ...
        <div class="modal-content relative z-10 overflow-y-auto! group min-h-[600px] min-w-[screen] max-h-[600px]">
            <div class="p-8">
                ...
                <div class="py-6">
                    <h2 class="text-fs12 font-bold mb-3 flex items-center gap-2">หมวดหมู่ <span
                ...
                <div class="py-6 border-t border-gray-200">
                    <h2 class="text-fs12 font-bold mb-3 flex items-center gap-2">เหมาะสำหรับ <span
                            class="icon-arrow-down block w-2.5"></span></h2>
