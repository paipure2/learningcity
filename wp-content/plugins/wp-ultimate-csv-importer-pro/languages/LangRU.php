...
class LangRU {
        ...
        public static function contents(){
                $response = array('ImportUpdate' => 'импорт',
                        ...
                        'Cancelled' => 'Отменено',
                        'Update' => 'Обновить',
                        'ExportBasedOnLanguageCode' => "Экспорт данных на основе кода языка",
                        ...
                        'MetaBoxGroupFields' => 'Групповые поля метабокса',
                        'MetaBoxRelationFields' => 'Поля отношений метабокса',
